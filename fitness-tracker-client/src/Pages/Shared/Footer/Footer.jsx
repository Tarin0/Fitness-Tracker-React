...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-[#71fc65] text-base-content">
  <nav>
    <header className="footer-title text-white">Services</header> 
    <a className="link link-hover text-white">Fitness</a>
    <a className="link link-hover text-white">Nutrition</a>
  ...
  <nav>
    ...
    <a className="link link-hover text-white">Fitness</a>
    <a className="link link-hover text-white">Join</a>
  </nav> 
  <nav>
...
<footer className="footer items-center p-4 bg-[#71fc65] mb-10 text-neutral-content">
