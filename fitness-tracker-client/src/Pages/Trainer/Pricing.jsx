        ...
        <div className="mx-4 flex flex-wrap justify-center">
          <div className="-mx-4 flex flex-wrap">
            <PricingCard
              ...
              buttonText="Join Now"
            >
              <List>Access to Silver-level <br />classes</List>
              <List>Basic fitness facilities</List>
            ...
            <PricingCard
              ...
              price="$199"
              subscription="month"
              description="Great for fitness enthusiasts who want more options."
              buttonText="Join Now"

            >
              <List>Access to Silver and Gold-level classes</List>
              <List>Advanced fitness facilities</List>
            ...
            <PricingCard
              ...
              price="$256"
              subscription="month"
              description="For serious fitness enthusiasts with unlimited access."
              buttonText="Join Now"
            >
              <List>Access to Silver, Gold, and Diamond-level classes</List>
              <List>Premium fitness facilities</List>
